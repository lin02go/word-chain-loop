...
var UI_TEXT = {
  zh: {
    ...
    startIntroCopy: '每次输入一个有效英文词，沿着末两位继续前进。用更少的词闭合环路，也可以在十二关挑战中争取三星。',
  ...
  en: {
    ...
    startIntroCopy: 'Enter a valid English word and continue from its final pair. Close the loop in fewer words, or chase three stars across twelve fixed challenges.',
